...
**Rol de este documento:** copy final sobre el storyboard visual ya aprobado en `04-storyboard-mes1.md`. No se modifica ningún concepto, slide, toma, encuadre ni prompt de IA — este documento solo redacta el texto en pantalla (donde el Director dejó **[ZONA DE TEXTO]**), el caption de publicación y los hashtags de cada una de las 8 piezas.

**Regla de correspondencia aplicada:** el storyboard marca explícitamente con **[ZONA DE TEXTO]** cada slide/toma que reserva espacio para tipografía en post-producción (ver `04-storyboard-mes1.md`, sección 0: "cada slide que necesita texto deja una zona de negativo... indicada como [ZONA DE TEXTO]"). Este documento escribe texto **únicamente** en esas slides/tomas marcadas. Las slides sin esa marca fueron diseñadas por el Director como puramente visuales (sin overlay) — se respetan como tal y no llevan texto en pantalla, aunque sí quedan reflejadas en el caption cuando corresponde.
...
- **Slides 1–6:** sin texto — el Director las dejó puramente visuales (ninguna trae [ZONA DE TEXTO]).
- **Slide 7 (cierre, [ZONA DE TEXTO] en tercio superior):**
...
**Plataforma:** Instagram (puente entre Reels/TikTok y Facebook). **Formato:** carrusel de 8 slides.

### Texto en pantalla

Sin texto en pantalla en ninguna slide — el Director diseñó las 8 slides de esta pieza como puramente visuales (ningún slide trae [ZONA DE TEXTO]; el recurso narrativo es el contraste antes/después con encuadre idéntico, no un overlay de texto).

### Caption (Instagram)

De la casa vacía a la casa que ya se siente de ustedes.

Cuando te cambias a un espacio más grande, no amueblas un rincón: amuebla la sala, el comedor y la recámara casi al mismo tiempo. Por eso arma sets completos tiene más sentido que ir pieza por pieza — y por eso, si prefieres organizarlo en pagos, la mayoría de nuestras colecciones están disponibles a meses sin intereses.
...
- **Slides 1–6:** sin texto — visuales (sin marca de zona; el contraste antes/después con encuadre idéntico transmite la historia sin overlay).
- **Slide 7 (cierre, [ZONA DE TEXTO]):**
...
**Plataforma:** Facebook + Instagram (pieza transversal a los 4 segmentos). **Formato:** carrusel de 7 slides.

### Texto en pantalla

- **Slide 1 (cover):** sin texto — el Director dejó "zona superior limpia" pero no la marcó con [ZONA DE TEXTO]; se respeta como slide visual.
- **Slides 2–6:** sin texto — visuales.
- **Slide 7 (cierre, [ZONA DE TEXTO]):**

> Así nace cada mueble Interimobel: hecho en México, hecho para durar.
...
- **Slides 1–5:** sin texto — visuales (sin marca de zona).
- **Slide 6 (cierre, [ZONA DE TEXTO]):**
...
**Plataforma:** Instagram (carrusel) / TikTok (formato carrusel de fotos). **Formato:** carrusel de 8 slides.

### Texto en pantalla

- **Slide 1 (cover):** sin texto — el Director dejó "zona central limpia" pero no la marcó con [ZONA DE TEXTO]; se respeta como slide visual.
- **Slides 2–7 (tips 1–6):** sin texto en pantalla — ninguna trae [ZONA DE TEXTO]; los 6 tips se comunican en el caption, no como overlay.
- **Slide 8 (cierre, [ZONA DE TEXTO]):**

> Y así, tu primer depa ya se siente tuyo.
...
**Plataforma:** Facebook + Instagram (Reels). **Duración:** 38 segundos, 7 tomas.

### Nota obligatoria sobre voiceover

El storyboard especifica para esta pieza **música instrumental cálida sin letra** ("Sonido/música... progresión instrumental cálida sin letra, sin caída dramática de urgencia") y establece que la tipografía en pantalla aparece **únicamente en la toma 7** ("nunca texto largo o narrativo superpuesto durante las tomas 1-6"). Es decir: el Director diseñó esta pieza deliberadamente como un recorrido silencioso, sin narración hablada — la progresión de luz y color *es* la narrativa (sección "Dirección de arte" del storyboard). Por respeto a esa decisión visual ya aprobada, este documento **no escribe un guion de voiceover para las tomas 1–6**, porque el storyboard no reserva ese espacio y añadir voz contradiría la dirección de arte ya definida. Lo que sigue es el texto en pantalla de la toma 7 (única con [ZONA DE TEXTO]) y el caption/hashtags de la publicación.

### Toma por toma (referencia, sin diálogo)

| Toma | Duración | Qué se ve (sin narración) | Texto en pantalla |
|---|---|---|---|
| 1 | 0:00–0:05 | Fachada de la casa, dolly in hacia la puerta | — |
| 2 | 0:05–0:10 | Depa de Segmento 1 recién amueblado | — |
| 3 | 0:10–0:16 | Sala+comedor de Segmento 2 | — |
| 4 | 0:16–0:22 | Sala modular de Segmento 3 | — |
| 5 | 0:22–0:28 | Habitación reconvertida de Segmento 4 | — |
| 6 | 0:28–0:34 | Fachada al anochecer, ventanas iluminadas | — |
| 7 | 0:34–0:38 | Tarjeta de cierre, fondo neutro cálido | **[ZONA DE TEXTO: tagline] ver abajo** |

### Texto en pantalla — Toma 7 (tarjeta de cierre)
