...
## Interimobel — 8 piezas (7 carruseles + 1 video ancla)

**Fecha:** 12 de julio de 2026. **Última revisión (13-jul-2026):** se retira el lenguaje técnico de cine/mercadotecnia de todo el documento — el protagonista de cada pieza es el espacio de la casa, no la cámara. Cómo se produce: se toma una foto real de un espacio y se redecora insertando las fotos de referencia del producto real de Interimobel (ver `04-storyboard-mes1.md`, ahora "Guía de Espacios").
**Veredicto general:** Listo para producción, con variantes/URLs de producto pendientes de confirmar (ver acciones pendientes).

**Paleta de producto del mes (las únicas 4 categorías permitidas):**
...
**Segmento 2 · Semana 2 · Carrusel 7 slides · Instagram**
...
**Texto en imagen:** ninguna slide lleva overlay — el antes/después es el recurso completo.
...
## Pieza 4 — "El cuarto que ahora es tu vestidor"
**Segmento 4 · Semana 2 · Carrusel 6 slides · Facebook**

**El espacio:** una habitación que quedó vacía encuentra, con calma, un nuevo uso como vestidor.

**Texto en imagen:** solo el cierre → *"Ese cuarto ya tiene un nuevo lugar en tu casa."*
...
**Todos los segmentos · Semana 3 · Carrusel 6 slides · Facebook + Instagram**
...
**Segmento 3 · Semana 3 · Carrusel 5 slides · Facebook**

**El espacio:** una casa donde solo se cambió lo que ya no daba más — la sala, y de forma discreta, también el comedor.

**Texto en imagen:** solo el cierre → *"Renovar no es empezar de cero. Es elegir con criterio lo que sigue."*
...
## Pieza 7 — "Piezas que valen la pena en tu primer espacio"
**Segmento 1 · Semana 4 · Carrusel 6 slides · Instagram/TikTok**

**El espacio:** el mismo primer depa de la Pieza 2, contado esta vez como consejos prácticos.

**Texto en imagen:** etiqueta corta por consejo (armario, comedor completo, rincón de bancos, luz natural) + cierre: *"Y así, tu primer depa ya se siente tuyo."*
...
**Todos los segmentos · Semana 4 · Video vertical, 30-35s, 6 escenas · Facebook + Instagram Reels**

**El espacio:** una sola casa, recorrida de principio a fin por sus cuatro etapas de vida — la entrada, el rincón de barra (Segmento 1), la sala y el comedor familiares (Segmento 2), la sala renovada (Segmento 3), el vestidor (Segmento 4), y el cierre con la fachada al anochecer. Música cálida e instrumental, sin voz — la luz y los espacios cuentan la historia solos.

**Texto en imagen:** solo el cierre →
> Interimobel
> La casa se acomoda.
...
1. Confirmar variante de acabado y URL exacta del Armario San Lorenzo Plus y del Banco Alto Mitlan.
2. Confirmar si el Banco Alto Mitlan se vende en pareja o como 2 unidades individuales al precio de lista.
3. Detalle completo del pivote de producto: `12-pivote-gama-media-alta.md`. Detalle de la guía de espacios: `04-storyboard-mes1.md`.
